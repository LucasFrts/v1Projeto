...
const getHttpSeach = ()=>{
    ...
    axios
    .post('http://127.0.0.1:5000/getSiteFromUrl', form)
...
<template>
        ...
        <div class="col-12 d-flex flex-row justify-content-center pt-3">
            <div class="input-group flex-nowrap mt-2">
                ...
                <input @keypress.enter="getHttpSeach" type="text" v-model="search" class="form-control text-white" placeholder="Seach with google" aria-label="search" aria-describedby="addon-wrapping">
            </div>
        </div>
</template>
<style scoped>
